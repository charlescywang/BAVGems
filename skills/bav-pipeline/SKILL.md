...
| 4 Modeler | `references/stage4_modeler.md` + `references/xlsx_patterns.md` | strategy_report.md, assumptions.json, workbook | assumption_map.md, workbook += Model tabs + Price Rationalization + Guidance & Consensus; memo.md; results into assumptions.json; scripts/build_model.py + rationalize_price.py + build_guidance.py |
